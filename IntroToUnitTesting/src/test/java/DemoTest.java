...
public class DemoTest {
	@Test
	public void test_is_regularTriangle_1() {
	...
	@Test
    public void test_is_regularTriangle_5() {
	...
	@Test
	public void test_is_NOT_triangle_sumEqualsLength3() {
		//Just no ...
		assertFalse(Demo.isTriangle(3, 2, 1));
	}

	@Test
	public void test_is_NOT_triangle_checkThreeZeroes() {
		//Just no ...
		assertFalse(Demo.isTriangle(0, 0, 0));
	}
	@Test
	public void test_is_NOT_triangle_checkNegativeAllNumber() {
		//Just no ...
